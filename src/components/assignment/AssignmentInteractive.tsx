      ...
      <Card noHover>
        <CardBody className="py-8">
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <a href={COURSE.routes.dashboard}>
    ...
    <Card noHover>
      <CardBody className="py-8 text-center">
        <div className="flex flex-col items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-sm border border-course-border bg-course-card">
            <WalletIcon />
          </div>
      ...
      <CardBody>
        <div className="space-y-4">
          ...
          <div className="rounded-sm border border-course-border overflow-hidden">
            <div className="flex items-center gap-1 border-b border-course-border bg-course-surface/50 px-2 py-1.5">
              {Array.from({ length: 6 }).map((_, i) => (
                <Skeleton key={i} className="h-6 w-6" />
              ))}
            </div>
            <div className="bg-course-surface/20 p-5">
