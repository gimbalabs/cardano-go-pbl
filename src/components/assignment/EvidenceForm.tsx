    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full rounded-sm border border-course-border bg-course-surface px-4 py-3 text-sm text-mn-text placeholder:text-mn-text-muted/50 focus:border-mn-primary-light focus:outline-none focus:ring-1 focus:ring-mn-primary-light disabled:opacity-50"
        />
      </div>
          ...
          {urls.map((url, index) => (
            <div key={index} className="flex items-center gap-2">
              <input
                ...
                disabled={isSubmitting || readOnly}
                className="flex-1 rounded-sm border border-course-border bg-course-surface px-4 py-2.5 text-sm text-mn-text placeholder:text-mn-text-muted/50 focus:border-mn-primary-light focus:outline-none focus:ring-1 focus:ring-mn-primary-light disabled:opacity-50"
              />
              {!readOnly && (
                <button
                  type="button"
                  ...
                  className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-sm border border-course-border text-mn-text-muted transition-colors hover:border-error/30 hover:text-error disabled:opacity-30"
                  title="Remove URL"
