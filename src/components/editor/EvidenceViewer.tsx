...
export function EvidenceViewer({ content }: EvidenceViewerProps) {
  ...
  if (content && !isTipTapContent(content)) {
    ...
    return (
      <div className="rounded-sm border border-course-border bg-course-card p-4 text-sm text-mn-text-muted">
  ...
  if (!content) {
    return (
      <div className="rounded-sm border border-course-border bg-course-card p-4 text-sm text-mn-text-muted italic">
...
function TipTapViewer({ content }: { content: JSONContent }) {
  ...
  return (
    <div className="rounded-sm border border-course-border bg-course-card p-4">
