...
import { CommitmentStatusBadge } from "@/components/assignment/CommitmentStatus";
  ...
  return (
    ...
    >
      ...
      <CardBody className="space-y-3">
        ...
        {/* Action link */}
        <a
          href={COURSE.routes.assignment(moduleCode)}
          className="inline-flex min-h-[44px] items-center gap-1 text-xs font-medium text-mn-primary transition-colors hover:text-mn-text"
        >
