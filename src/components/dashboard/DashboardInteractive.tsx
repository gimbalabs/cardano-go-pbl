...
function DashboardLoadingSkeleton() {
  return (
    <div className="space-y-10">
      {/* Account skeleton */}
      <div className="rounded-sm border border-course-border bg-course-card">
        <div className="border-b border-course-border px-5 py-4">
      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: COURSE.moduleCount }).map((_, i) => (
            <div key={i} className="rounded-sm border border-course-border bg-course-card px-4 py-4 sm:px-6">
      ...
      <div>
        <Skeleton className="h-5 w-36 mb-5" />
        <div className="rounded-sm border border-course-border bg-course-card px-5 py-6">
          <div className="space-y-3">
