...
export function RegistrationFlow() {
  ...
  return (
    <div className="mx-auto max-w-md space-y-6 rounded-sm border border-course-border bg-course-card p-4 sm:p-6">
      <div className="space-y-2 text-center">
        <h2 className="font-heading text-xl font-semibold text-mn-text">
          Welcome to Cardano Go PBL
        </h2>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full rounded-sm border border-course-border bg-course-surface px-4 py-2.5 text-sm text-mn-text placeholder:text-mn-text-muted/50 focus:border-mn-primary-light focus:outline-none focus:ring-1 focus:ring-mn-primary-light disabled:opacity-50"
            />
            <p className="text-xs text-mn-text-muted">
