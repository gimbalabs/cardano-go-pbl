...
function WalletControllerInner() {
    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="rounded-md px-2 py-1 text-xs text-mn-text-muted transition-colors hover:bg-course-surface hover:text-mn-text min-h-[44px] min-w-[44px]"
  ...
  if (isAuthenticating) {
    return (
      <div className="flex h-9 items-center gap-2 rounded-sm border border-course-border bg-course-surface px-3">
        <svg
  ...
  if (status === "NEEDS_REGISTRATION" && connected) {
    return (
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={handleLogout}
          className="rounded-md px-2 py-1 text-xs text-mn-text-muted transition-colors hover:bg-course-surface hover:text-mn-text min-h-[44px]"
          title="Disconnect wallet"
        >
          Disconnect
        </button>
  ...
  if (error && connected) {
    return (
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={handleRetry}
          className="rounded-md border border-course-border bg-course-surface px-3 py-2 text-xs text-mn-text-muted transition-colors hover:text-mn-text min-h-[44px]"
        >
          Retry
        </button>
      </div>
  ...
  return (
    <div className="[&_button]:!rounded-sm [&_button]:!border [&_button]:!border-course-border [&_button]:!bg-course-surface [&_button]:!px-4 [&_button]:!py-2 [&_button]:!text-sm [&_button]:!text-mn-text [&_button]:!font-medium [&_button]:!transition-colors [&_button]:hover:!bg-course-card">
      <CardanoWallet />
    </div>
  );
}
