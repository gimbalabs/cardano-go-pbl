...
* A running Dolos instance configured for **preprod** (see the Dolos setup lesson). [Dingo](https://github.com/blinklabs-io/dingo) works in the same role — substitute its socket path and network magic wherever the lesson references `dolos.socket` or `dolos.toml`.
* Go 1.21+ installed
* Git installed
